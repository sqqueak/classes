...
def hog_pile_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 11
    print("DEBUG:", score, picky_piggy(opponent_score))
    if hog_pile(score+picky_piggy(opponent_score), opponent_score) >= cutoff or picky_piggy(opponent_score) >= cutoff:
        return 0
    else:
        return num_rolls
    # END PROBLEM 11

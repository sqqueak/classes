...
def distance(city_a, city_b):
    ...
    5.0
    """
    lat = abs(get_lat(city_a) - get_lat(city_b))
    lon = abs(get_lon(city_a) - get_lon(city_b))
...
def closer_city(lat, lon, city_a, city_b):
    ...
    'Bucharest'
    """
    if distance(make_city("coord", lat, lon), city_a) > distance(make_city("coord", lat, lon), city_b):
